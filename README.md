# Helmify
[![CI](https://github.com/ezeriver94/helmify/actions/workflows/ci.yml/badge.svg)](https://github.com/ezeriver94/helmify/actions/workflows/ci.yml)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/ezeriver94/helmify)](https://goreportcard.com/report/github.com/ezeriver94/helmify)
[![GoDoc](https://godoc.org/github.com/ezeriver94/helmify?status.svg)](https://pkg.go.dev/github.com/ezeriver94/helmify?tab=doc)
...
See [examples](https://github.com/ezeriver94/helmify/tree/main/examples) of charts generated by helmify.
...
- With operator-sdk version < v1.23.0 
    ...
    helmify:
    	$(call go-get-tool,$(HELMIFY),github.com/ezeriver94/helmify/cmd/helmify@v0.3.7)
...
- With operator-sdk version >= v1.23.0
    ...
    $(HELMIFY): $(LOCALBIN)
    	test -s $(LOCALBIN)/helmify || GOBIN=$(LOCALBIN) go install github.com/ezeriver94/helmify/cmd/helmify@latest
...
Or download suitable for your system binary from [the Releases page](https://github.com/ezeriver94/helmify/releases/latest).
